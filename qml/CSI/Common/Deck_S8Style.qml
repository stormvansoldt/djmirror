...
Module
{
  ...
  property bool   s12Mode: false
  property bool   fineDeckTempoAdjust: true
...
//------------------------------------------------------------------------------------------------------------------
// DECK FOCUS AND SINGLE DECK MODE
//------------------------------------------------------------------------------------------------------------------
  ...
  Wire { enabled: !module.shift; from: "%surface%.display.buttons.5";  to: ButtonScriptAdapter { onPress: handleViewButton(); } }
  Wire { enabled: !module.shift; from: "%surface%.display.buttons.5.led";    to: "ScreenViewBlinker"  }
  ...
  Wire { from: "%surface%.browse.push"; to: SetPropertyAdapter { path: propertiesPath + ".overlay"; value: Overlay.none } enabled: screenOverlay.value == Overlay.browserWarnings }
      ...
      WiresGroup
      {
        ...
        WiresGroup
        {
          ...
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.1.tempo.fine" : "decks.1.tempo.coarse";   enabled: !module.shift }
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.1.tempo.coarse" : "decks.1.tempo.fine"; enabled:  module.shift }
        }
        ...
        WiresGroup
        {
          ...
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.2.tempo.fine" : "decks.2.tempo.coarse";   enabled: !module.shift }
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.2.tempo.coarse" : "decks.2.tempo.fine"; enabled:  module.shift }
        }
        ...
        WiresGroup
        {
          ...
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.3.tempo.fine" : "decks.3.tempo.coarse";   enabled: !module.shift }
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.3.tempo.coarse" : "decks.3.tempo.fine"; enabled:  module.shift }
        }
        ...
        WiresGroup
        {
          ...
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.4.tempo.fine" : "decks.4.tempo.coarse";   enabled: !module.shift }
          Wire { from: "%surface%.browse"; to: (module.fineDeckTempoAdjust) ? "decks.4.tempo.coarse" : "decks.4.tempo.fine"; enabled:  module.shift }
        }
      }
        ...
        if (footerHasDetails)
        {
          ...
          while (true)
          {
            ...
            switch (tempPage)
            {
              ...
              case FooterPage.slot4:
                tempPage = (module.s12Mode ? FooterPage.midi : FooterPage.fx);
              break;
        ...
        if (footerHasDetails)
        {
          ...
          while (true)
          {
            ...
            switch (tempPage)
            {
              ...
              case FooterPage.midi:
                tempPage = (module.s12Mode ? FooterPage.slot3 : FooterPage.fx);
              break;
          }
      ...
      WiresGroup
      {
        enabled: !isInEditMode && module.screenView.value == ScreenView.deck && !showMySettings.value
  ...
  WiresGroup
  {
    ...
    WiresGroup
    {
      ...
      WiresGroup
      {
        enabled: hasWaveform(deckAType) && !module.shift && !showMySettings.value
    ...
    WiresGroup
    {
      ...
      WiresGroup
      {
        enabled: hasWaveform(deckBType) && !module.shift && !showMySettings.value
    ...
    WiresGroup
    {
      ...
      WiresGroup
      {
        enabled: hasWaveform(deckCType) && !module.shift && !showMySettings.value
    ...
    WiresGroup
    {
      ...
      WiresGroup
      {
        enabled: hasWaveform(deckDType) && !module.shift && !showMySettings.value
  ...
  WiresGroup
  {
    ...
    WiresGroup
    {
      enabled: decksAssignment == DecksAssignment.AC && !deckFocus && module.s12Mode
    ...
    WiresGroup
    {
      ...
      WiresGroup
      {
        ...
        Wire { from: "%surface%.fx.buttons.1";   to: "fx_units.3.enabled" }
        Wire { from: "%surface%.fx.buttons.2";   to: "fx_units.3.button1" }
        Wire { from: "%surface%.fx.buttons.3";   to: "fx_units.3.button2" }
        Wire { from: "%surface%.fx.buttons.4";   to: "fx_units.3.button3" }
      }

      Wire { from: "softtakeover_knobs1.module.output"; to: "fx_units.3.dry_wet" }
      Wire { from: "softtakeover_knobs2.module.output"; to: "fx_units.3.knob1" }
      Wire { from: "softtakeover_knobs3.module.output"; to: "fx_units.3.knob2" }
      Wire { from: "softtakeover_knobs4.module.output"; to: "fx_units.3.knob3" }
    }

    // Effect Unit 2
    WiresGroup
    {
      enabled: decksAssignment == DecksAssignment.BD && !deckFocus && module.s12Mode
    ...
    WiresGroup
    {
      ...
      WiresGroup
      {
        ...
        Wire { from: "%surface%.fx.buttons.1";   to: "fx_units.4.enabled" }
        Wire { from: "%surface%.fx.buttons.2";   to: "fx_units.4.button1" }
        Wire { from: "%surface%.fx.buttons.3";   to: "fx_units.4.button2" }
        Wire { from: "%surface%.fx.buttons.4";   to: "fx_units.4.button3" }
      }

      Wire { from: "softtakeover_knobs1.module.output"; to: "fx_units.4.dry_wet" }
      Wire { from: "softtakeover_knobs2.module.output"; to: "fx_units.4.knob1" }
      Wire { from: "softtakeover_knobs3.module.output"; to: "fx_units.4.knob2" }
      Wire { from: "softtakeover_knobs4.module.output"; to: "fx_units.4.knob3" }
    }
  ...
  //  SETTINGS CONTROLS
  //------------------------------------------------------------------------------------------------------------------
  // Wire para activar settings con SHIFT + display button 5
  MappingPropertyDescriptor { id: showMySettings; path: propertiesPath + ".showMySettings"; type: MappingPropertyDescriptor.Boolean; value: false }
  Wire {
      enabled: module.shift && !isInEditMode && module.screenView.value == ScreenView.deck
      from: "%surface%.display.buttons.5"
      to: TogglePropertyAdapter { 
          path: propertiesPath + ".showMySettings"
      }
  }

  MappingPropertyDescriptor { id: settingsNavigateRight; path: settingsPath + ".settingsNavigateRight"; type: MappingPropertyDescriptor.Boolean; value: false }
  MappingPropertyDescriptor { id: settingsNavigateLeft; path: settingsPath + ".settingsNavigateLeft"; type: MappingPropertyDescriptor.Boolean; value: false }
  MappingPropertyDescriptor { id: settingsNavigateDown; path: settingsPath + ".settingsNavigateDown"; type: MappingPropertyDescriptor.Boolean; value: false }
  MappingPropertyDescriptor { id: settingsNavigateUp; path: settingsPath + ".settingsNavigateUp"; type: MappingPropertyDescriptor.Boolean; value: false }
  MappingPropertyDescriptor { id: settingsNavigateToggleIncrement; path: settingsPath + ".settingsNavigateToggleIncrement"; type: MappingPropertyDescriptor.Boolean; value: false }
  MappingPropertyDescriptor { id: settingsNavigateToggleDecrement; path: settingsPath + ".settingsNavigateToggleDecrement"; type: MappingPropertyDescriptor.Boolean; value: false }

  WiresGroup
  {
    enabled: !isInEditMode && module.screenView.value == ScreenView.deck && showMySettings.value

    // Wire para navegar Right
    Wire {
        from: "%surface%.display.buttons.8"
        to: TogglePropertyAdapter { 
            path: settingsPath + ".settingsNavigateRight"
        }
    }

    // Wire para navegar Left
    Wire {        
        from: "%surface%.display.buttons.4"
        to: TogglePropertyAdapter { 
            path: settingsPath + ".settingsNavigateLeft"
        }
    }

    // Wire para navegar Up
    Wire {
        from: "%surface%.display.buttons.6"
        to: TogglePropertyAdapter { 
            path: settingsPath + ".settingsNavigateUp"
        }
    }

    // Wire para navegar Down
    Wire {
        from: "%surface%.display.buttons.7"
        to: TogglePropertyAdapter { 
            path: settingsPath + ".settingsNavigateDown"
        }
    }

    // Wire para cambiar valor de la opción actual    
    Wire {
        from: "%surface%.display.buttons.2"
        to: TogglePropertyAdapter { 
            path: settingsPath + ".settingsNavigateToggleIncrement"
        }
    }

    // Wire para decrementar valor de la opción actual
    Wire {
        from: "%surface%.display.buttons.3"
        to: TogglePropertyAdapter { path: settingsPath + ".settingsNavigateToggleDecrement" }
    }
  }
