...
Module
{
  ...
  WiresGroup
  {
    enabled: (!channel.shift || (fxMode.value == FxMode.TwoFxUnits)) && !channel.mixerFXSelector && !channel.prioritizeFXSelection
  ...
  WiresGroup
  {
    enabled: (!channel.shift) && channel.mixerFXSelector && !channel.prioritizeFXSelection
    Wire { from: surface_prefix + "fx.assign.1"; to: TogglePropertyAdapter { path: app_prefix + "fx.assign.1"; } }
    Wire { from: surface_prefix + "fx.assign.2"; to: TogglePropertyAdapter { path: app_prefix + "fx.assign.2"; } }
  }
  ...
  WiresGroup
  {
    enabled: (channel.shift && (fxMode.value == FxMode.FourFxUnits)) && !channel.mixerFXSelector && !channel.prioritizeFXSelection
  ...
  WiresGroup
  {
    enabled: (channel.shift && (!mixerFXOn.value && fxMode.value == FxMode.FourFxUnits)) && channel.mixerFXSelector && !channel.prioritizeFXSelection
    Wire { from: surface_prefix + "fx.assign.1"; to: TogglePropertyAdapter { path: app_prefix + "fx.assign.3"; } }
    Wire { from: surface_prefix + "fx.assign.2"; to: TogglePropertyAdapter { path: app_prefix + "fx.assign.4"; } }
  }
  ...
  WiresGroup
  {
    enabled: (channel.shift && (mixerFXOn.value || fxMode.value == FxMode.TwoFxUnits)) && channel.mixerFXSelector && !channel.prioritizeFXSelection
    Wire { from: surface_prefix + "fx.assign.1"; to: ButtonScriptAdapter { onRelease: { mixerFX.value = (mixerFX.value + 4) % 5; } } }
    Wire { from: surface_prefix + "fx.assign.2"; to: ButtonScriptAdapter { onRelease: { mixerFX.value = (mixerFX.value + 1) % 5; } } }
  }
