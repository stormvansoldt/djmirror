...
Rectangle {
  ...
  property int     fxUnitId:        (prefs.s12Mode ? deckId : deckIds[ ((fxSelectionState.value < FxOverlay.lower_button_1) || (fx4Mode.value == FxMode.TwoFxUnits)) ? 0 : 1 ] )// denotes if upper or lower fx unit is seleted
