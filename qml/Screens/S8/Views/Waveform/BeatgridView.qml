...
Traktor.Beatgrid {
  ...
  Traktor.WaveformTranslator {
    ...
    Traktor.BeatgridLines
    {
      ...
      height: prefs.fullHeightBeatgridLines ? parent.height : prefs.heightBeatgridLines
    ...
    Traktor.BeatgridLines
    {
      ...
      anchors.left:         parent.left
      anchors.right:        parent.right
      height: prefs.heightBeatgridLines
    ...
    Traktor.BeatgridLines
    {
      ...
      anchors.left:         parent.left
      anchors.right:        parent.right
      height: prefs.fullHeightRedBeatgridLines ? parent.height : prefs.heightRedBeatgridLines
    ...
    Traktor.BeatgridLines
    {
      ...
      anchors.left:         parent.left
      anchors.right:        parent.right
      height: prefs.heightRedBeatgridLines
