...
Item {
  ...
  SingleWaveform {
    ...
    anchors.bottomMargin: (slicer.enabled) ? 11 : 2
    ...
    Item {
        ...
        Rectangle {
            ...
            property int sliceModeHeight: (stemStyle == StemStyle.track) ? 
                waveformContainer.height - 14 : waveformContainer.height - 10
            
            y: 0
            width: prefs.playmarkerWidth || 2
            height: (slicer.enabled && !beatgrid.editEnabled) ? 
                    sliceModeHeight - 2 : waveformContainer.height + 2
        ...
        Item {
            ...
            Repeater {
                model: 3
                Canvas {
                    width: topTriangle.width
                    height: topTriangle.height
                    y: 0
                    x: ((playmarkerRect.width - width) / 2)
                    opacity: 0.35 - (modelData * 0.1)
                    ...
                    onPaint: {
                        ...
                        ctx.lineTo(width, 0)
                        ctx.closePath()
                        ctx.fillStyle = colors.colorBluePlaymarker
                        ctx.fill()
                    }
                }
            }
        ...
        Item {
            ...
            Repeater {
                model: 3
                Canvas {
                    width: bottomTriangle.width
                    height: bottomTriangle.height
                    y: playmarkerRect.height - 8
                    x: (playmarkerRect.width - width) / 2
                    opacity: 0.35 - (modelData * 0.1)
  ...
  StemColorIndicators {
    ...
    indicatorHeight: (slicer.enabled && !beatgrid.editEnabled ) ? [33 , 33 , 33 , 33] : (prefs.displayHotCueBar) ? [26, 26, 26, 26] : [30 , 30 , 30 , 30]
  }
