...
Rectangle {
  ...
  readonly property int   maxHeight:          20 * screenScale
  ...
  readonly property variant xPositioning: [
    9 * screenScale, 
    129 * screenScale, 
    324 * screenScale, 
    369 * screenScale
  ...
  // dividers
  Rectangle { id: line1; visible: !isAnalyzing; width: 1 * screenScale; height: footer.height; color: colors.colorDivider; x: 119 * screenScale }
  Rectangle { id: line2; visible: !isAnalyzing; width: 1 * screenScale; height: footer.height; color: colors.colorDivider; x: 359 * screenScale }
  ...
  Repeater {
    ...
    Text {
      ...
      width:                  (footer.width/4 - 12) * screenScale         // 3px space left and right
