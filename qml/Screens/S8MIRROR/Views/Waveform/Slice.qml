...
Item {
  ...
  Rectangle {
    id: backgroundColor
    anchors.fill:         parent
    anchors.bottomMargin: (stemStyle == StemStyle.track) ? (17 * screenScale) : (12 * screenScale)
  ...
  Rectangle {
    ...
    anchors.fill: parent
    anchors.bottomMargin: 17 * screenScale
    anchors.leftMargin:   1 * screenScale
  ...
  Rectangle {
    ...
    property int box_height: (stemStyle == StemStyle.track) ? (13 * screenScale) : (9 * screenScale)
    height: box_height
